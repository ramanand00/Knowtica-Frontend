...
const chatUsersData = [
  { id: 1, name: 'Alice', profileImage: '', lastMessage: 'Hello there!', time: '2:00 PM', unread: 3, online: true },
  { id: 2, name: 'Bob', profileImage: '', lastMessage: 'How are you?', time: '1:30 PM', unread: 0, online: false },
  { id: 3, name: 'Charlie', profileImage: '', lastMessage: 'Meeting at 5?', time: '12:00 PM', unread: 1, online: true },
];
...
export default function ChatSidebar({ onSelectUser }) {
  ...
  return (
    <div className="w-80  border-r bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex flex-col">
      {/* Search & Sort Header */}
            ...
            >
              <div className="flex items-center">
                <div className="relative w-10 h-10 mr-3">
                  {user.profileImage ? (
                    <img src={user.profileImage} alt={user.name} className="rounded-full w-10 h-10" />
                  ) : (
