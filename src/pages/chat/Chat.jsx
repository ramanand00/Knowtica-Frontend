  ...
  return (
    <>
      ...
      <div className="flex h-screen pt-16">
        ...
        <div className="flex flex-col flex-1 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
          <div className="p-4 bg-blue-600 text-white font-bold shadow flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className="text-lg">{dummyUser.name}</div>
                <div className="text-xs font-normal opacity-80">Last seen at {dummyUser.lastSeen}</div>
              </div>
            </div>
            ...
            {messages.map(msg => (
              ...
              >
                <div className={`max-w-sm px-4 py-2 rounded-lg shadow ${
                  msg.sender === 'Me' ? 'bg-blue-500 text-white' : 'bg-white dark:bg-gray-800'
                }`}>
          ...
          <div className="p-4 border-t bg-white dark:bg-gray-800 flex items-center gap-3 relative">
            <button
            ...
            {showOptions && (
              <div className="absolute bottom-16 left-4 flex gap-2 bg-white dark:bg-gray-700 p-2 rounded shadow">
            ...
            <input
              ...
              className="flex-1 px-4 py-2 rounded-full border dark:border-gray-700 focus:outline-none"
            />
            <button
              onClick={handleSend}
